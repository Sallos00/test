...
class LipSyncGUIRun:
    ...
    def _check_auth_on_start(self):
        ...
        if local:
            ...
            _threading.Thread(target=_check_pending, daemon=True).start()
    ...
    def _show_auth_request_popup(self):
        ...
        def _on_approved(token):
            ...
            tk.Label(popup,
                     ...
                     bg=self.BG, fg=self.TEXT, justify="center").pack(pady=(round(20*r2), round(20*r2)))
